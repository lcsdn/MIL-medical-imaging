...
class EmbeddingLevelModel(StructuredMILModel):
...
class EmbeddingLevelModelWithPatientData(EmbeddingLevelModel):
    def __init__(self, hparams):
        super().__init__(hparams)
...
class EmbeddingLevelModelWithPatientDataAndDeepClassifier(EmbeddingLevelModelWithPatientData):
    def __init__(self, hparams):
        super().__init__(hparams)
